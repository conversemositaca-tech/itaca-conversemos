...
from pacientes.api import AdjuntoViewSet, AplicacionEscalaViewSet, AtencionViewSet, BloqueoAgendaViewSet, CitaViewSet, ObjetivoTerapeuticoViewSet, PacienteViewSet, TareaViewSet, TranscribirView
