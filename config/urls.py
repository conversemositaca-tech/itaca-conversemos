...
from core.mi_panel import MiPanelView
...
from faro.api import (AlertasView, AtenderAlertaView, CuestionarioView,
                      PanelFaroView, ResultadosView)
...
router.register(r"escalas", AplicacionEscalaViewSet, basename="escala")
...
urlpatterns = [
    ...
    # Panel del psicólogo (su inicio: contenido institucional + sus KPIs).
    path("api/mi-panel/", MiPanelView.as_view(), name="mi-panel"),
    ...
    path("api/integraciones/respaldo/", RespaldoView.as_view(), name="integ-respaldo"),
